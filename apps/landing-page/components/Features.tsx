...
export default function Features() {
  return (
    <div className="relative flex flex-col items-center justify-center px-10 mt-32">
      {/* Ping dot + Section Heading */}
      ...
      {/* Section Subtitle */}
      <div className="text-gray-400 mb-8 text-center text-lg max-w-xl">
